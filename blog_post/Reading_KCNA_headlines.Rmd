...
author: "[Xavier Marquez](http://abandonedfootnotes.blogspot.com)"
output: 
  html_document: 
    self_contained: no
    toc: yes
...
(Warning: long and exhaustive discussion of propaganda that nobody reads or cares about, by [a non-specialist in North Korean politics](http://abandonedfootnotes.blogspot.com). Contains complicated interactive graphs best viewed on a laptop or desktop computer). 
...
topic_terms <- topic_terms %>%
  mutate(topic_descriptive = paste(c(
        ...
        "6 Diplomacy?", 
         "1 Achievements of the Kims?"), terms, sep = "\n"),
         order = str_extract(topic_descriptive, "[0-9]+") %>%
           as.numeric())
